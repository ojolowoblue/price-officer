...
>(({ className, ...props }, ref) => (
  <div className="flex items-center rounded-lg border px-3" cmdk-input-wrapper="">
    <MapPin className="mr-2 h-3 w-3 shrink-0 opacity-50" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'flex h-11 w-full break-words text-wrap rounded-md bg-transparent py-3 text-sm outline-none placeholder:text-slate-500 disabled:cursor-not-allowed disabled:opacity-50 placeholder:text-sm',
        className,
      )}
      {...props}
    />
