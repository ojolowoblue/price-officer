  ...
  return (
    <div className="app-x-spacing py-5 pb-20">
      <div className="flex flex-col gap-4 mb-6">
        <h3 className="text-base font-medium text-foreground leading-5">About Price Police</h3>
      ...
      <div className="mb-6">
        ...
        <p className="text-muted text-sm leading-6">
          ...
          By leveraging the power of community contributions, we collect real-time data on a wide range of products,
          from groceries and electronics to clothing and household items. Our platform allows you to:
        </p>
